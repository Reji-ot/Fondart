...
<hr>
        <!-- Products -->
        <section id="products" class="justify-content-center text-center">
            
               <h2 class="font-Trajan font-size-40 color-gold my-5 pt-5 text-center">OUR SHELF</h2>
               <div class="text-center container justify-content-center mx-auto w-90"> 
                   <div id="filters" class="button-group text-end font-baloo font-size-16 text-center px-3">
                        ...
                        <button class="btn color-gold" data-filter=".Sandwich">Sandwich</button>
